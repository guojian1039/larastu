// 从刚刚安装的库中加载数据
const addressData=require('china-area-data/v5/data.json');
    ...
    methods:{
        setFromValue(value){
           ...
           // 过滤掉空值
            ...
            var provinceId=_.findKey(this.provinces,o=>o===value[0]);
            // 没找到，清空省的值
            if(!provinceId)
            {
                this.provinceId='';
            ...
            var cityId=_.findKey(addressData[provinceId],o=>o===value[1]);
            // 没找到，清空城市的值
            if(!cityId)
            {
                this.cityId='';
            ...
            var districtId=_.findKey(addressData[cityId],o=>o===value[2]);
            // 没找到，清空省的值
            if(!districtId)
            {
                this.districtId='';
