                    ...
                    <div class="col-lg-3">
                        <div class="shop-widgets">
                            ...
                            <div class="single-widget widget-recommended-products mt-30">
                                ...
                                @include('home.silder_product',['items'=>$skill_products,'sclass'=>'recommended-products-slider-2 slider-navigation-2 slider-navigation-2-m0','different_class'=>'hoproduct-4'])
                            </div>
                            <!--// Recommended Product -->
            ...
            */
            ...
            $('.shop-filters-viewmode').on('click', 'button', function () {
                ...
                if (dataView == 'list') {
                    ...
                    setCookie('dataView','list');
                } else {
                    $('.shop-page-products').removeClass('list-view-active');
                    setCookie('dataView','grid');
                }
            });

            switch(getCookie('dataView')){
                case 'list':
                    $('.shop-page-products').addClass('list-view-active');
