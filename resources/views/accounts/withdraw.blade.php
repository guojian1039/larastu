...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-grey">
            ...
            <li class="breadcrumb-item active" aria-current="page">提现</li>
        </ol>
    </nav>
    <!-- Page Conttent -->
                    ...
                    <div class="col-lg-9">
                        <div class="row row-cols-1 row-cols-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="{{ route('users.withdraw.update') }}" >
                                        @csrf
                                        <div class="form-group row">
                                            <label for="moneynum" class="col-md-4 col-form-label text-md-right">金额(元)</label>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control  {{ $errors->has('moneynum') ? ' is-invalid' : '' }}" required name="moneynum" id="moneynum">
                                                @error('moneynum')
